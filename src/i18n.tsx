...
export const EN: Record<string, string> = {
  ...
  Свои: "Custom",
  Экспорт: "Export",
  "JSON — полные данные": "JSON — full data",
  "SARIF — для CI и code scanning": "SARIF — for CI & code scanning",
  "Markdown — для тикета или чата": "Markdown — for a ticket or chat",
  "CSV — открыть в Excel": "CSV — open in Excel",
  ...
  "Высоких": "High",
  "Секретов": "Secrets",
  "Уязвимых зависимостей": "Vulnerable dependencies",
  ...
  "По ответственным": "By responsible",
  "Excel (книга)": "Excel (workbook)",
  "Многолистовая книга: сводка с оценкой и динамикой, таблица находок, разбивка по ответственным. Открывается в Excel и LibreOffice без плагинов.":
    "A multi-sheet workbook: a summary with score and dynamics, a findings table, and a per-responsible breakdown. Opens in Excel and LibreOffice with no plugins.",
  "Экспорт в Excel (книга)": "Export to Excel (workbook)",
  "Excel — книга с листами и разбивкой": "Excel — workbook with sheets and breakdown",
  "сводка, находки, ответственные": "summary, findings, responsibles",
  "Показатель": "Metric",
  "Значение": "Value",
  Проект: "Project",
  Дата: "Date",
  ...
  "Доля устранённых": "Remediation rate",
  "исправлено от всех активных": "fixed of all active",
  "Доля достижимых": "Reachable share",
  "реально эксплуатируемы": "actually exploitable",
  "Строк проверено": "Lines scanned",
  "Зависимостей": "Dependencies",
  "Время": "Duration",
  "Скорость": "Throughput",
  "с": "s",
  "файлов в секунду": "files per second",
  "Достижима": "Reachable",
  "и ещё {n} находок в полном отчёте": "and {n} more findings in the full report",
  "Первое сканирование — база для сравнения заложена.": "First scan — a baseline for comparison is set.",
  "Защищённость выросла: новых проблем нет, часть устранена.":
    "Posture improved: no new issues, some were fixed.",
  "Защищённость снизилась: новых проблем больше, чем устранено.":
    "Posture declined: more new issues than were fixed.",
  "Есть прогресс: устранено больше, чем появилось.":
    "Progress: more fixed than appeared.",
  "Без заметных сдвигов с прошлого скана.": "No notable change since the last scan.",
  ...
  "Показаны подавленные": "Suppressed shown",
  ...
  "Редактировать": "Edit",
  "Изменить код и перепроверить": "Edit the code and re-check",
  // Theme presets: `t(p.label)` / `t(p.hint)` take these dynamically, so the
  // static i18n audit cannot see them — they are listed here by hand.
  "Ночь": "Night",
  "Как задумано: тёмно-синие поверхности, синий акцент": "As designed: deep blue surfaces, blue accent",
  "Полночь": "Midnight",
  "Почти чёрный, для OLED и тёмной комнаты": "Near-black, for OLED and a dark room",
  "День": "Day",
  "Светлая схема целиком, включая подсветку кода": "A full light scheme, code highlighting included",
  "Контраст": "Contrast",
  "Максимальная разница: чистый чёрный фон, яркий текст": "Maximum separation: pure black background, bright text",
  "Тайга": "Taiga",
  "Тёмная зелень, мягкий изумрудный акцент": "Dark greens, soft emerald accent",
  "Океан": "Ocean",
  "Глубокая бирюза, холодный бирюзовый акцент": "Deep teal, cool cyan accent",
  "Аметист": "Amethyst",
  "Фиолетовые поверхности, сиреневый акцент": "Violet surfaces, lilac accent",
  "Графит": "Graphite",
  "Нейтральный серый без синевы, спокойный акцент": "Neutral grey with no blue cast, calm accent",
  "Бумага": "Paper",
  "Тёплая светлая: кремовые поверхности, мягкий контраст": "Warm light: cream surfaces, gentle contrast",
  "Дымка": "Mist",
  "Светлая холодная: серо-голубые поверхности": "Cool light: blue-grey surfaces",
  "Редактирование": "Editing",
  "Перепроверка встроенными правилами": "Re-checked with built-in rules",
  "Сохранить и перепроверить": "Save & re-check",
  "Чисто": "Clean",
  "Все находки в файле исправлены.": "All findings in the file are fixed.",
  "Исправлено: {fixed}. Осталось: {rest}.": "Fixed: {fixed}. Remaining: {rest}.",
  "Осталось: {rest}.": "Remaining: {rest}.",
  "Новых: {n}.": "New: {n}.",
  "Исправлено находок: {n}": "Findings fixed: {n}",
